...
namespace Qy_CSharp_NetWork.Tools.Other
{
    class GetMacAdress
    {
        public GetMacAdress() { }
        public static string[] GetAllMacs()
        {
            ...
            System.Collections.Generic.List<string> macsList = new System.Collections.Generic.List<string>();
            foreach (NetworkInterface ne in net)
            {
                macsList.Add(ne.GetPhysicalAddress().ToString());
            }
            return macsList.ToArray();
        }
